 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */const _C=new le(V.comparator);function ln(){return _C}const R0=new le(V.comparator);function Ki(...t){let e=R0;for(const n of t)e=e.insert(n.key,n);return e}function C0(t){let e=R0;return t.forEach((n,r)=>e=e.insert(n,r.overlayedDocument)),e}function nr(){return us()}function k0(){return us()}function us(){return new Ri(t=>t.toString(),(t,e)=>t.isEqual(e))}const vC=new le(V.comparator),EC=new Oe(V.comparator);function j(...t){let e=EC;for(const n of t)e=e.add(n);return e}const wC=new Oe(G);function TC(){return wC}/**
 * @license
 * Copyright 2020 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
 ...
 * See the License for the specific language governing permissions and
 * limitations under the License.
 */class Gl{constructor(e,n,r,i,s){this.snapshotVersion=e,this.targetChanges=n,this.targetMismatches=r,this.documentUpdates=i,this.resolvedLimboDocuments=s}static createSynthesizedRemoteEventForCurrentChange(e,n,r){const i=new Map;return i.set(e,_o.createSynthesizedTargetChangeForCurrentChange(e,n,r)),new Gl(M.min(),i,new le(G),ln(),j())}}class _o{constructor(e,n,r,i,s){this.resumeToken=e,this.current=n,this.addedDocuments=r,this.modifiedDocuments=i,this.removedDocuments=s}static createSynthesizedTargetChangeForCurrentChange(e,n,r){return new _o(r,n,j(),j(),j())}}/**
 * @license
 * Copyright 2017 Google LLC
 *
 * Licensed under the Apache License, Version 2.0 (the "License");
